...
public class User implements Serializable, UserDetails {
    ...
    // FetchType.EAGER = User and Permission are fetched together.
    // FetchType.LAZY = One entity is fetched after the other.
    ...
    // Converting roles to permission so UserDetails can use our permission list.
